...
class DHT11:
    def __init__(self, screen, x, y,r, rotation = 360):
        ...
        self.screen = screen
        self.item = [self.item_rect[0], self.item_rect.y + 8*r, self.item_rect[2], self.item_rect.y + 42*r]
        self.pin_pos_dict = {
            "0": (self.item_rect.center[0] + 17*r, self.item_rect.center[1] - 2*r),
            "1": (self.item_rect.center[0] + 17*r, self.item_rect.center[1]),
            "2": (self.item_rect.center[0] + 17*r, self.item_rect.center[1] + 2*r)
        }
